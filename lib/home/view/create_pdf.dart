...
class CreatePDF extends StatelessWidget {
  ...
  static pw.Widget buildCustomHeadline(StudentState state) => pw.Header(
        level: 0,
        child: pw.Row(
  ...
  Future<Uint8List> _generatePdf(
      PdfPageFormat format, StudentState state) async {
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (context) => [
          ...
          pw.Header(
            child:
                pw.Text("Relationship to Present Student in School (IF ANY)"),
          ),
          pw.SizedBox(height: space),
          pw.Table(
            border: pw.TableBorder.all(),
